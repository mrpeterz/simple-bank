...
class BankBranchTransferServiceTest extends KernelTestCase
{
    ...
    public function testBankBranchTransferServiceWithInvalidArgumentThrowException()
    {
        $this->expectException(InvalidArgumentBankTransferException::class);
